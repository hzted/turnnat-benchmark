...
VAP_ROOT = REPO_ROOT / "dualturn-main" / "baselines" / "vap"
...
def main() -> None:
    ...
    ap.add_argument("--min-utterance-s", type=float, default=0.2, help="Minimum VAD utterance duration for units. 0.2s keeps short backchannels while filtering very brief noise.")
